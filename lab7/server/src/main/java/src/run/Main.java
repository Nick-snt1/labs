...
public class Main{
    ...
    static ExecutorService receiverService = Executors.newFixedThreadPool(10);

    static ExecutorService responderService = Executors.newFixedThreadPool(20);
    ...
    public static void main(String[] args) {
        ...
        try{
            DatabaseHandler database = new DatabaseHandler(URL, LOGIN, PASSWORD);

            UsersCollectionHandler usersHandler = new UsersCollectionHandler(database.getConnection());
            ...
            Thread save = new SaveThread(handler, usersHandler, database, invoker, serverChannel, receiverService);
            save.start();
