...
public class UsersCollectionHandler {
    ...
    public synchronized String registration(User user) throws Exception {
        try {
            ...
            return "User with login " + user.getLogin() + " already exists!";
        }
    }

    public synchronized String authorization(User user) throws Exception {
        try {
